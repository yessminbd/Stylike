...
const Hero = () => {
    return (
        <>
            <section className='max-padd-container max-xl:mt-8 pb-16 sm:pb-0 lg:pb-0 '>
                <div className='max-padd-container xl:bg-hero bg-cover bg-center bg-no-repeat h-[550px] w-full  mt-10'>
                    <div className='relative max-w-[777px] top-9'>
                        ...
                        <div className='flex gap-2 sm:gap-6'>
                            <Link className='btn-dark max-sm:p-3 text-center'>Produits Populaires</Link>
                            <Link to={'/login'} className='btn-secondary max-sm:p-3 text-center'>Rejoins-nous</Link>
                        </div>
                    </div>
                </div>
            </section>
